...
.writePalette:
	...
	move.l	#$40200000,VDP_CTRL	;	Give command to write to VRAM at $0020 ($0000 purposefely left blank so that any uninitialised data has no tile shown)
.writeTile:
	move.l	(a0)+,d4
	move.l	d4,VDP_DATA
	dbra	d0,.writeTile
...
.writeNameTable:
	...
	move.l	#$40000003,VDP_CTRL	;	Give command to write to PlaneA NameTable at TBC
.loopOuter:
.loopInner:
...
waterfallUpdate:
	...
	and.w #%00000111,d1					; and against bottom bits to do modulo 8 (colors array size)
...
.writePalette:
	...
	and.w #%00000111,d1					; and against bottom bits to do modulo 8 (palette array size)
